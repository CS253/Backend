// controllers/routePlannerController.js
...
/**
 * New unified controller for frontend payload:
 * {
 *   departureTime: "15:05",
...
async function planRouteController(req, res, next) {
  try {
    ...
    // If optimized is true, we need start
    if (optimized === true) {
    ...
    // If optimized is false, preserve incoming order
    const result = await getManualRouteWithPlaceInfo({
      departureTime,
      destinations
    });
